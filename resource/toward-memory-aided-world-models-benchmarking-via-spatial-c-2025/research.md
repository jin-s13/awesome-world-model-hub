...
- reproducibility: 100.0 - Screens links and visible text for paper, code, dataset, artifact, and repository signals.
...
- topical_relevance: 70.0 - Uses existing LLM keyword relevance scores normalized to 0-100.
